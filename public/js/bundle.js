...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidHJhbmRodW5nIiwiYSI6ImNsMmxud280YzBhbXEzbG54bW1qNnhqcHIifQ.sfGaY-o0OekXTGTI-RNjIw';
...
var stripe = Stripe('pk_test_51Kx4izAv33riEHeTosKRobz49zTCE2wl317Sa617D3BVUPH89HFrA1Hnaz39kKEp1V4if6kbJddJA0UCDcAXLmGY00kIacpfF3');
...
var $ = document.querySelector.bind(document); // DOM ELEMENTS

var loginForm = $('.form--login');
var map = $('#map');
var logOutBtn = $('.nav__el--logout');
var updateDataBtn = $('.btn--save--settings');
var updatePasswordForm = $('.form-user-password');
var userImgEl = $('.form__user-photo');
var userImgInputEl = $('#photo');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            newPasswordConfirm = $('#password-confirm').value;
            _context.next = 7;
